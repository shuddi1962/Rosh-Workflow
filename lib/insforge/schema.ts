...
// ---- Operations module (inventory, receipt custody & staff reporting) ----
...
export interface InventoryMovement {
  ...
  movement_type: 'received' | 'issued' | 'sold' | 'transferred' | 'returned' | 'adjustment' | 'damaged' | 'lost' | 'opening_balance'
  product_id: string
