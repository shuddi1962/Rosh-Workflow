...
export const PROGRAM_PHASES: ProgramPhase[] = [
  ...
  { id: 'P10', label: 'Accounting & finance', status: 'NOT STARTED', detail: 'CoA, GL, journals, AR/AP, banking & feeds, expenses, assets, budgets, loans, tax, close — no tables yet.' },
  ...
  { id: 'P18', label: 'Projects & Field Service', status: 'IN PROGRESS', detail: 'Project tracking + field jobs/dispatch live on work_schedules. GPS, photos, checklists, sign-off, manufacturing, fleet, industry verticals pending.' },
