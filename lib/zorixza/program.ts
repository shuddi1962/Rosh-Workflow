...
export const PROGRAM_PHASES: ProgramPhase[] = [
  ...
  { id: 'P5', label: 'Database foundation & migrations', status: 'IMPLEMENTED', detail: 'Migrations 001–009 versioned. CoA/HR/audit tables pending.' },
  ...
  { id: 'P9', label: 'Purchasing & suppliers', status: 'IN PROGRESS', detail: 'Suppliers, PO, GRN live. RFQ, quotes, bills, landed cost pending.' },
  ...
  { id: 'P12', label: 'HR core', status: 'NOT STARTED', detail: 'Employees, departments, documents, cases.' },
  ...
  { id: 'P16', label: 'Document Control & Cloud Storage', status: 'IMPLEMENTED', detail: 'Drive, custody, shares, versions, quotas live. Retention rules pending.' },
  { id: 'P17', label: 'Reports, schedules & workflows', status: 'IMPLEMENTED', detail: 'Daily/monthly reports, schedules, approvals engine live.' },
  { id: 'P18', label: 'Projects & Field Service', status: 'NOT STARTED', detail: 'Jobs, dispatch, GPS, checklists, sign-off.' },
