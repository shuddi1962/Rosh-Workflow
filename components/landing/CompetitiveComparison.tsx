    ...
    <section id="compare" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#F6F9FD]">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#0A1833] mb-4">ROSH vs Fragmented Multi-Tool Stack</h2>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-[#F6F9FD]">
                ...
                <th className="text-center p-4 font-semibold text-[#1468F5]">ROSH AI Operating System</th>
