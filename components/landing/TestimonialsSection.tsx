...
const testimonials = [
  { name: 'Emeka Okoro', role: 'CEO, Roshanal Infotech', text: 'Zorixza auto-responds to WhatsApp inquiries in 12 seconds. Our lead conversion jumped 40% in the first month. The competitor spy feature alone paid for the entire platform.', stars: 5 },
...
export const TestimonialsSection: React.FC = () => (
    ...
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-slate-600">See how businesses like yours are growing with Zorixza.</p>
      </div>
