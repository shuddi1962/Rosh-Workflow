...
const testimonials = [
  { name: 'Emeka Okoro', role: 'CEO, Roshanal Infotech', text: 'Rosh auto-responds to WhatsApp inquiries in 12 seconds. Our lead conversion jumped 40% in the first month. The competitor spy feature alone paid for the entire platform.', stars: 5 },
  ...
  <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#F6F9FD]">
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-slate-600">See how businesses like yours are growing with ROSH.</p>
      </div>
