...
const testimonials = [
  { name: 'Emeka Okoro', role: 'CEO, Roshanal Infotech', text: 'Rosh AI auto-responds to WhatsApp inquiries in 12 seconds. Our lead conversion jumped 40% in the first month. The competitor spy feature alone paid for the entire platform.', stars: 5 },
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {testimonials.map((t) => (
          <div key={t.name} className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-sm text-slate-700 leading-relaxed mb-6 italic">&quot;{t.text}&quot;</p>
            <div>
