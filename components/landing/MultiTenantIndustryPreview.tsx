    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#071426]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto">Zorixza is built as a multi-tenant platform, allowing every business to operate inside its own secure workspace while using the same powerful infrastructure.</p>
        </div>
