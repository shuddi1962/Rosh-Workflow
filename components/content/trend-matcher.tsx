    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="font-clash text-lg font-semibold text-text-primary flex items-center gap-2">
          <TrendingUp className="w-5 h-5 text-accent-primary-glow" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div>
          ...
          <div className="space-y-2">
            {trends.map((trend) => (
              <div key={trend.id} className="bg-bg-surface border border-border-subtle rounded-lg p-3">
                ...
                <div className="flex flex-wrap gap-1 mt-2">
                  ...
                  <span className="text-xs text-accent-primary-glow">{trend.division_relevance}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            {products.map((product) => (
              <div key={product.id} className="bg-bg-surface border border-border-subtle rounded-lg p-3">
                <div className="flex items-center justify-between">
      ...
      {matches.length > 0 && (
        <div>
          ...
          <div className="space-y-2">
            {matches.map((match, i) => (
              <div key={i} className="bg-bg-surface border border-border-subtle rounded-lg p-3 flex items-center gap-3">
                <TrendingUp className="w-4 h-4 text-accent-primary-glow" />
