      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-white to-bg-surface p-12 flex-col justify-between relative overflow-hidden border-r border-border-subtle">
        ...
        >
          {[
            ...
            <div key={i} className="flex items-center gap-4 text-text-primary">
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative">
        ...
        >
          ...
          <div className="bg-white rounded-2xl border border-border-subtle p-8 shadow-lg">
            <div className="mb-8">
              <h2 className="font-clash text-2xl font-bold text-text-primary mb-2">Welcome back</h2>
            ...
            {error && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="flex items-center gap-3 p-4 bg-accent-red/10 border border-accent-red/20 rounded-xl mb-6"
              >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-text-muted hover:text-text-secondary transition"
                  >
