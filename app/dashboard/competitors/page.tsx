    ...
    <div className="max-w-full mx-auto">
      <div className="mb-8">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h1 className="font-clash text-3xl font-bold text-text-primary mb-2">Competitor Spy</h1>
            <p className="text-text-secondary">Monitor competitors and discover content gaps</p>
          </div>
      ...
      {showAddForm && (
        <div className="bg-white rounded-xl border border-border-subtle p-6 mb-6">
          <h3 className="font-clash text-lg font-semibold text-text-primary mb-4">Add New Competitor</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full p-2 border border-border-default rounded-lg"
              >
        ...
        {competitors.length === 0 ? (
          ...
          <>
            <div className="bg-white rounded-xl border border-border-subtle p-4">
              ...
              <p className="text-2xl font-bold text-text-primary font-mono">{competitors.length}</p>
            </div>
            <div className="bg-white rounded-xl border border-border-subtle p-4">
              <div className="flex items-center gap-2 mb-2">
          ...
          {competitors.map((competitor) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="font-clash text-lg font-semibold text-text-primary mb-1">
                    {competitor.name}
                  </h3>
                  <div className="flex items-center gap-3 text-sm text-text-muted">
                    {competitor.website && (
                      <a href={competitor.website} target="_blank" rel="noopener noreferrer" className="hover:text-accent-primary">
                        {competitor.website}
                      </a>
                    )}
                    <Badge variant={competitor.division === 'marine' ? 'default' : 'info'}
                      className={competitor.division === 'marine' ? 'bg-accent-primary/10 text-accent-primary' : 'bg-accent-purple/10 text-accent-purple'}
                    >
                      {competitor.division}
                    </Badge>
                  </div>
              ...
              {competitor.active_ads && competitor.active_ads.length > 0 && (
                <div className="mt-3 pt-3 border-t border-border-ghost">
