...
import { Users, Plus, Search, Phone, Mail, Filter, UserPlus } from "lucide-react"
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-text-muted text-sm">Manage and track all your business leads</p>
      </div>
      ...
      <div className="bg-bg-surface rounded-lg border border-border-subtle p-4">
        <div className="flex flex-col md:flex-row gap-3 mb-4">
          ...
          <div className="flex gap-2">
            ...
            <Button className="bg-gradient-to-r from-accent-primary to-accent-primary-glow text-text-on-accent">
          ...
          <TableBody>
            {filtered.map((lead) => (
              <TableRow key={lead.id}>
                ...
                <TableCell>
                  <Badge status={lead.division_interest === "marine" ? "scheduled" : "live"}>
