  ...
  return (
    <div>
      ...
      <div className="bg-bg-surface rounded-lg border border-border-subtle p-6">
        <h3 className="font-clash font-semibold text-text-primary mb-4">Lead Pipeline</h3>
        <p className="text-text-muted">No leads yet. Use the "Scrape Leads" button to find potential customers.</p>
      </div>
    </div>
  )
}
